...
export function AiStartupMentorSection() {
  return (
    <section className="px-4 pt-16 pb-16 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-5xl rounded-2xl border border-amber-500/10 bg-linear-to-r from-amber-500/5 to-yellow-500/5 p-6 sm:p-7 lg:px-10 lg:pt-10 lg:pb-8">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          ...
          <Button asChild variant="primary-gradient" size="lg" className="w-full sm:w-52">
